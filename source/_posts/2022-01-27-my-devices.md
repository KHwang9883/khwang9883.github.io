...
- **SSD1**: 铠侠 EXCERIA SSD (RC10) NVMe 1TB
- **SSD2**: 铠侠 EXCERIA G2 SSD (RC20) NVMe 2TB
- **HDD**: 东芝 DT01ACA300 3TB
- **显示器 (主)**: 创维 F27G32Q Pro 27" (2560x1440)
...
- **RAM**: 2GB DDR3 1333MT/s
- **HDD**: WDC WD3200BEKT-60V5T1 320GB
- **屏幕**: 14.1" LCD (1366x768)
- **OS**: Windows 8.1 32-bit

### 存储设备
- `铠侠 EXCERIA SSD (RC10)` 500GB + `ITGZ M.2 NVMe 固态移动硬盘盒`
- `WD Elements` 1TB
- `SanDisk CZ73` 64GB
- `SanDisk CZ73` 32GB

### 网络设备
- `兆能讯通 ZN-M5` Wi-Fi 6 AX3000
- `中国移动智能家庭网关 H3-2s`
...
### 荣耀 V8 高配版
- **状态**: 闲置
- **备注**: 由于更换了非官方副板，USB 口无法传输数据；电池鼓包
- **购买时间**: 2017-01
- **SoC**: 海思麒麟 955
