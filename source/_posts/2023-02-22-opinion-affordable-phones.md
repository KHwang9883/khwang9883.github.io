...
新荣耀应该是可以从华为手机保留 App 数据换机的，原机用华为的手机克隆，新机用荣耀的换机克隆即可。对于其他品牌，App 数据无法保留，不过也无所谓，根据 [我的经验](https://kevinh.wang/junk-phones/)，起码微信聊天记录可以导过去。
...
**（2023-03-20 更新）**由于 Z7 系列的发布，Z6 系列可以不用看了。新发布的 `iQOO Z7` 系列中，Z7 是骁龙 782G 处理器，5000mAh+120W 的续航组合，而 `iQOO Z7x` 则是同档唯一的 6000mAh+80W，骁龙 695 处理器。两者都没有超广角镜头，略显遗憾。iQOO Z7 / iQOO Z7x 8GB+256GB 参考价 1699（日常 1799）/ 1499 元，两者都值得考虑。
